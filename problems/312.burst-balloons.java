 ...
 */
class Solution {
    //If we were to break all the smaller number first, then we can result in a higher
    // number at the end. But the thing is, we have to always hit the one in the middle (unless the
    // side is smaller?
